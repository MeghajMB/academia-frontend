      ...
      <main className="pt-24">
        ...
        <section className="hero bg-[#0f0f0f] text-white py-16">
          <div className="container mx-auto text-center">
            <h1 className="text-3xl font-bold">Become an Instructor at Academia</h1>
        ...
        <section className="benefits py-16">
          <div className="container mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
              ...
              <div className="benefit">
                <h3 className="text-xl font-semibold">Reach a Global Audience</h3>
                <p className="text-gray-500">
        ...
        <section className="cta py-16 text-center">
          <div className="container mx-auto">
            ...
            <p className="mt-4 text-xl">Join Academia and start teaching today!</p>
            <Link
              href="/home/teaching/register"
